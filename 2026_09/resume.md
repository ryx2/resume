...
Applied AI: AI/LLMs, OpenAI, Anthropic, Gemini, Open source models, PydanticAI, MCP, Harnesses, Tool calls, Model evaluation, Agentic memory, Prompting, Self improving agents
...
- Raised $120,000 for RayXC. Hit 6k MRR with Raysurfer.com, an AI employee that got better as it learned about your customers with agentic memory and agentic voting based on customer interaction.
...
- Co-founded an AI home-buying company with over $500,000 in total commission revenue and 19 homebuyers from approximately 350 leads. Raised $1.3 million from Y Combinator, Pioneer Fund, and other angel investors.
- Managed two employees, one engineer and one designer.
- Built agents and tool-execution harnesses with OpenAI o1 for crafting texts, Anthropic's sonnet 3.5 and sonnet 4 for tool calling, Gemini for document summary, and PydanticAI typing for buyer communication, tour scheduling, and property research.
...
- Built a GPT-4 email service that automatically summarized real-estate disclosure documents for home buyers.
...
- Google Assistant (May 2022 - Apr 2023): Improved BERT embeddings for matching related voice queries on the NLP retrieval team; built experiment pipelines for new model features.
- Document AI, small model training team (Oct 2020 - May 2022): Improved document named entity recognition (NER) in low-data settings with fewer than 10 examples.
- Pretrained BiLSTM models with spatial invoice features and ran fine-tuning and tokenization experiments.
...
Cornell University | Bachelor of Science, Electrical and Computer Engineering | 2017

Y Combinator | Summer 2024 (S24) | Modern Realty
