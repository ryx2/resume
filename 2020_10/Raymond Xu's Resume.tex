...
\begin{document}
	...
	\begin{itemize}
		...
		\item[\textbf{Political Activism}:] \textit{Tech for Campaigns}, calls, door knocking during election cycles \hfill July 2018 - Present % change this structure to be more clear whether the calls and door knocking was for tfa
