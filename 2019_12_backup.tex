...
\begin{document}
	...
	\setlength{\parindent}{-0ex} \par
		...
		% $\boldsymbol{\cdot}$ Designed programs in MATLAB, Java, C++ for an agile software team and a systems engineering team. \par
		...
		% $\boldsymbol{\cdot}$ Automated USPS driver monitoring for illegal driving with GPS data. Spoke at meetings with the customer management about program details. Designed algorithms, performed code reviews and aided program releases. \par 
		\vspace{-1ex}
