...
\begin{document}
    ...
    $\boldsymbol{\cdot}$ On the Document AI product team \par \vspace{+1ex}
    $\boldsymbol{\cdot}$ Developing NLP machine learning algorithms for analyzing text on forms and other documents. \par \vspace{+1ex}
    ...
    $\boldsymbol{\cdot}$ Improved machine learning training pipelines in Google's proprietary language (borg). \par \vspace{+1ex}
    \vspace{+1ex}
	...
	\begin{itemize}
	 ...
	 %    \item[\textbf{Peer Advising}:] Led orientation sessions and advised freshman on course selection \hfill August 2016 - May 2018 
		...
		\item[\textbf{Other}:] \href{https://www.youtube.com/channel/UC8Ta5a_8R0GkBeSkG0ArZ9Q}{Youtube Channel}, Radio show hosting, intramural sports
	\end{itemize}
	\end{document}
